...
\begin{enumerate}
    ...
    \begin{align}
        ...
        \label{eq:nonconvex}
    \end{align}
    Hence, the optimization problem is nonconvex as the set of points on the 
    parabola do not form a convex set. The constraints throw an error when 
    \textit{cvxpy} is used, as shown in the erroneous Python code
