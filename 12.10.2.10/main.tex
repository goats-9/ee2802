...
\begin{enumerate}
    \item Find a vector in the direction of the vector $\myvec{5\\-1\\2}$ which
    has magnitude 8 units.
    
    \solution Let the required vector be $c\myvec{5\\-1\\2}$, where $c\in\mathbb{R}$.
    ...
    \begin{align}
        ...
        \label{eq:const}
    \end{align}
    Thus, the required vector is $\frac{4\sqrt{30}}{15}\myvec{5\\-1\\2}$. The
    solution is verified in the Python code \texttt{codes/mag.py}.
\end{enumerate}
\end{document}
