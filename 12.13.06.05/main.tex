...
\begin{enumerate}
    ...
    \solution Let the random variable $X$ denote one single draw with $p$ being 
    ...
    \end{align}
    \begin{enumerate}
        \item We require $\pr{Y=6}$. Thus,
            \begin{align}
                \pr{Y=6} &= \myvec{n\\6}p^6\brak{1-p}^0 \\
                         &= 0.004096
            \end{align}

        \item We require $\pr{Y\ge4}$. Thus,
            \begin{align}
                \pr{Y\ge4} &= \sum_{k=4}^6\pr{Y=k} \\
                           &= \sum_{k=4}^6\myvec{n\\k}p^k\brak{1-p}^{n-k} \\
                           &= 0.1792
            \end{align}

        \item We require $\pr{Y\le5}$. Since $n = 6$ in \eqref{eq:pmf-Y},
            \begin{align}
                \pr{Y\le5} = 1 - \pr{Y=6} = 0.995904
            \end{align}

        \item We require $\pr{Y=3}$. Thus,
            \begin{align}
