...
\begin{enumerate}
    ...
    \end{align}
    \begin{enumerate}
        \item We require $\pr{Y=6}$. Thus, from \eqref{eq:pmf-Y},
            \begin{align}
        ...
        \item We require $\pr{Y\ge4}$. Thus, from \eqref{eq:cdf-Y},
            \begin{align}
                \pr{Y\ge4} &= 1 - \pr{Y<4} \\
        ...
        \item We require $\pr{Y\le5}$. Since $n = 6$ in \eqref{eq:cdf-Y},
            using \eqref{eq:ans-a} gives
            \begin{align}
                \pr{Y\le5} &= F_Y\brak{5} \\
                           &= 1 - \pr{Y=6} \\
                           &= 0.995904
