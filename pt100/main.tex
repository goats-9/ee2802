...
\subsection{Pseuso-Inverse Method}
...
Notice in \eqref{eq:opt-theta} that the optimal value of $C$ in \eqref{eq:model}
is negative, and hence the governing equation is strictly concave. Hence, we
cannot use gradient descent methods to solve this problem.
