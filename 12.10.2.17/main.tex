...
\providecommand{\inp}[2]{\ensuremath{\langle#1,#2\rangle}}
...
\begin{enumerate}
    ...
    \begin{align}
        \inp{\vec{c}}{\vec{a}} &= \vec{c}^\top\vec{a} = -35 \\
        \inp{\vec{a}}{\vec{b}} &= \vec{a}^\top\vec{b} = 6 \\
        \inp{\vec{b}}{\vec{c}} &= \vec{b}^\top\vec{c} = 0
        \label{eq:inner-prod}
    \end{align}

    From \eqref{eq:inner-prod}, $\inp{\vec{b}}{\vec{c}} = 0$, which implies 
    that $\vec{b} \perp \vec{c}$. Hence, $\Delta ABC$ is right angled at $A$. 
