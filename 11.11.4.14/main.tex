...
\begin{enumerate}
    ...
    The general expression of the centre of the circle is given by
    \begin{align}
        \vec{c} &= -\vec{V}^{-1}\vec{u} \\
        ...
        \label{eq:center}
    \end{align}
    and so, $\vec{c}$ lies on the $y$-axis. However, $\vec{c}$ also lies on the
    $x$-axis since it is the major axis. Therefore, $\vec{c} = -\vec{u} = \vec{0}$.
    Thus, from \eqref{eq:u-val},
    \begin{align}
        \vec{F} = \myvec{ce^2\\0}
        \label{eq:F-c-e}
    \end{align}
