...
\begin{enumerate}
    ...
    \begin{align}
        ...
        \label{eq:circ-point}
    \end{align}
    where $\theta_i \in (0,2\pi]$. Since $P_1P_2P_3P_4$ is a parallelogram, 
    its diagonals bisect each other. Thus, using \eqref{eq:circ-point}
    \begin{align}
        ...
        \label{eq:norm-diag}
    \end{align}
    Using \eqref{eq:norm-diag}, we have
    \begin{align}
        \brak{\cos\theta_1+\cos\theta_3}^2+\brak{\sin\theta_1+\sin\theta_3}^2 \nonumber \\
        = \brak{\cos\theta_2+\cos\theta_4}^2+\brak{\sin\theta_2+\sin\theta_4}^2 \\
        \implies \cos\brak{\theta_1-\theta_3}=\cos\brak{\theta_2-\theta_4} \\
        \implies \brak{\theta_1-\theta_3} = \brak{\theta_2-\theta_4} + 2n\pi
        \label{eq:inner-diag}
    \end{align}
    Since the points are taken in anticlockwise order, 
