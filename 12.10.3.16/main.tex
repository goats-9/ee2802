...
\begin{enumerate}
    ...
    \solution The area of $\triangle ABC$ is given by
    \begin{align}
        \textrm{ar}\brak{\triangle ABC} &= \frac{1}{2}
    ...
    \end{align}
    since $2C_2 = C_3$ in \eqref{eq:det}. This is verified in the Python code
    \texttt{codes/det.py}. Therefore, the given points are collinear.
\end{enumerate}
\end{document}
